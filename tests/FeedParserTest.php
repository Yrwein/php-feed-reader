...
class FeedParserTest extends TestCase
{
    ...
    public function testParseFeedToArticles_WithRssFeed()
    {
        $feedParser = new FeedParser();
        $articles = $feedParser->parseFeedToArticles(file_get_contents(ROOT_DIR . '/tests/_fixtures/omgubuntu.com.rss.xml'));
        $this->assertCount(3, $articles);
